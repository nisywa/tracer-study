            ...
            class="wow fadeInUp rounded-lg bg-white dark:bg-dark-2 py-10 px-8 shadow-testimonial dark:shadow-none sm:py-12 sm:px-10 md:p-[60px] lg:p-10 lg:py-12 lg:px-10 2xl:p-[60px]">
               ...
               @foreach ($pertanyaans as $pertanyaan)
                  <div class="mb-[22px]">
                          ...
                          @elseif($pertanyaan->tipe=="checkbox")
                            @foreach ($pertanyaan->template_jawaban as $option)
                            <label for="option2" class="flex items-center text-sm text-body-color dark:text-dark-6">
               ...
               @endforeach
                <div class="mb-0 flex justify-end gap-4">
                  <a href="{{ route('survey.survey') }}" class="inline-flex items-center justify-center px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out rounded-md bg-primary hover:bg-blue-dark">
                    Batal
                  </a>
