                    ...
                    <div class="flex-auto p-6">
                        ...
                        <div class="w-full px-3 mb-4">
                         ...
                         <div class="flex justify-end items-center mt-4">
                            <a href="{{ route('admin.atasan.index') }}" class="inline-block px-8 py-2 w-36 h-10 font-bold text-center align-middle transition-all ease-in border border-gray-300 rounded-lg text-gray-700 bg-transparent hover:bg-gray-100 text-xs tracking-tight-rem cursor-pointer mr-4">Batal</button> </a>
