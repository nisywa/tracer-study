                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="icon-container">
                                                ...
                                                <!-- Delete -->
                                                <a href="javascript:;" class="icon-link" data-tooltip="Delete" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $atasan->id }}').submit();">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                                <form id="delete-form-{{ $atasan->id }}" action="{{ route('admin.atasan.destroy', $atasan) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form> 
